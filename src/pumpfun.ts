...
export class PumpFunSDK {
  ...
  async buy(
    ...
    for (let i = 0; i < chunks.length; i++) {
      let buyTx = await this.getBuyInstructionsBySolAmount(
        chunks[i].map(item => item.publicKey),
        mint,
        buyAmountSol,
        slippageBasisPoints,
        commitment
      ...
      console.log(`${i}: ${chunks[i][0].publicKey.toBase58()}`)
      buyTx.feePayer = buyers[0].publicKey;
      ...
      // console.log("🚀 ~ PumpFunSDK ~ sig:", sig)
  ...
  async getBuyInstructionsBySolAmount(
    ...
    console.log("🚀 ~ PumpFunSDK ~ buyers:", buyers)
    ...
    console.log("🚀 ~ PumpFunSDK ~ associatedBondingCurve:", associatedBondingCurve.toBase58())
